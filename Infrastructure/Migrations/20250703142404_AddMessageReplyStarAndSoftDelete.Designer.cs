...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250703142404_AddMessageReplyStarAndSoftDelete")]
    partial class AddMessageReplyStarAndSoftDelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.AIModels.UserVoiceModel", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.Chatting.ConversationUser", b =>
                {
                    ...
                    b.Property<bool>("TranslateMessages")
                        .HasColumnType("bit");

                    b.Property<bool>("UseRobotVoice")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.Entities.Users.User", b =>
                {
                    ...
                    b.Property<bool>("IsTrainedVoice")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.Entities.Chatting.ImageMessage", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.Chatting.TextMessage", b =>
                {
                    ...
                    b.Property<string>("TranslatedContents")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.Chatting.VoiceMessage", b =>
                {
                    ...
                    b.Property<string>("TranslatedVoiceUrl")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TranslatedVoiceUrls")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("Messages", t =>
                        {
                            t.Property("IsTranslated")
                                .HasColumnName("VoiceMessage_IsTranslated");
                        });
            ...
            modelBuilder.Entity("Domain.Entities.Chatting.Message", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Chatting.Message", "ReplyToMessage")
                        .WithMany()
